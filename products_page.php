        ...
        <ul class="products">
            <li>
                <div class="products_item">
                    <a href="product1_detail.php" class="products_thumb">
                        <img src="css/assets/images/products/af1(2.1).png" alt="">
                    </a>
                </div>
                <div class="products_info">
                    <a href="product1_detail.php" class="products_name">Nike Air Force 1 '07</a>
            ...
            <li>
                <div class="products_item">
                    <a href="product3_detail.php" class="products_thumb">
                        <img src="css/assets/images/products/panda()1.png" alt="">
                    </a>
                </div>
                <div class="products_info">
                    <a href="product3_detail.php" class="products_name">Nike Dunk High Retro</a>
                    <div class="product-pride">3,369,000₫</div>
                </div>
            </li>
            <li>
                <div class="products_item">
                    <a href="product2_detail.php" class="products_thumb">
                        <img src="css/assets/images/products/dunk-low-red(1).png" alt="">
                    </a>
                </div>
                <div class="products_info">
                    <a href="product2_detail.php" class="products_name">Air Jordan 1 Low</a>
                    <div class="product-pride">3,239,000₫</div>
                </div>
            </li>
            <li>
                <div class="products_item">
                    <a href="" class="products_thumb">
                        <img src="css/assets/images/products/dunk-low-retro(1).png" alt="">
                    </a>
                </div>
                <div class="products_info">
                    <a href="" class="products_name">Nike Court Vision Low</a>
                    <div class="product-pride">2,069,000₫</div>
                </div>
            </li>
            <li>
                <div class="products_item">
                    <a href="" class="products_thumb">
                        <img src="css/assets/images/products/dunk-low-retro-Z(1).png" alt="">
                    </a>
                </div>
                <div class="products_info">
                    <a href="" class="products_name">Nike Blazer Low '77 Jumbo</a>
                    <div class="product-pride">2,779,000₫</div>
                </div>
            </li>
            <li>
                <div class="products_item">
                    <a href="" class="products_thumb">
                        <img src="css/assets/images/products/jordan-1.1.png" alt="">
                    </a>
                </div>
                <div class="products_info">
                    <a href="" class="products_name">Jordan Nu Retro 1 Low</a>
                    <div class="product-pride">3,089,000₫</div>
                </div>
            </li>
            <li>
                <div class="products_item">
                    <a href="" class="products_thumb">
                        <img src="css/assets/images/products/dunklow23.png" alt="">
                    </a>
                </div>
                <div class="products_info">
                    <a href="" class="products_name">Nike Air Force 1 '07</a>
                    <div class="product-pride">$1499</div>
                </div>
            </li>
            <li>
                <div class="products_item">
                    <a href="" class="products_thumb">
                        <img src="css/assets/images/products/dunk-low-greeen2.png" alt="">
                    </a>
                </div>
                <div class="products_info">
                    <a href="" class="products_name">Dunk Low Green 2</a>
                    <div class="product-pride">$2000</div>
                </div>
            </li>
            <li>
                <div class="products_item">
                    <a href="" class="products_thumb">
                        <img src="css/assets/images/products/nike-dunk2.png" alt="">
                    </a>
                </div>
                <div class="products_info">
                    <a href="" class="products_name">Nike dunk </a>
                    <div class="product-pride">$2000</div>
                </div>
            </li>

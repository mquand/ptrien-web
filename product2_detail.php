    ...
    <div class="content ">
        <div class="content-item">
            <div class="content-item--left">
                ...
                <div class="images">
                    <div class="small_img">
                        <img src="css/assets/images/products/dunk-low-red.png" onclick="showimg(this.src)">
                    </div>
                    <div class="small_img">
                        <img src="css/assets/images/products/dunk-low-red3.png" onclick="showimg(this.src)">
                    </div>
                    <div class="small_img">
                        <img src="css/assets/images/products/dunk-low-red2.png" onclick="showimg(this.src)">
                    </div>
                    <div class="small_img">
                        <img src="css/assets/images/products/dunk-low-red4.png" onclick="showimg(this.src)">
                    </div>
                </div>
                <div class="big_img">
                    <img src="css/assets/images/products/dunk-low-red.png">
                </div>
            </div>
            <div class="content-item--right">
                <div class="products_info">
                    <div class="products_name">Air Jordan 1 Low</div>
                ...
                <div class="mota">Sự rạng rỡ vẫn tồn tại trong
                    Air Jordan 1 Low, phiên bản bóng rổ nguyên bản mang

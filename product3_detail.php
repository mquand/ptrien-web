    ...
    <div class="content ">
        <div class="content-item">
            <div class="content-item--left">
                ...
                <div class="images">
                    <div class="small_img">
                        <img src="css/assets/images/products/panda.png" onclick="showimg(this.src)">
                    </div>
                    <div class="small_img">
                        <img src="css/assets/images/products/Nike Dunk High Retro-dau.png" onclick="showimg(this.src)">
                    </div>
                    <div class="small_img">
                        <img src="css/assets/images/products/Nike Dunk High Retro-sau.png" onclick="showimg(this.src)">
                    </div>
                    <div class="small_img">
                        <img src="css/assets/images/products/Nike Dunk High Retro-sau2.png" onclick="showimg(this.src)">
                    </div>
                </div>
                <div class="big_img">
                    <img src="css/assets/images/products/panda.png">
                </div>
            </div>
            <div class="content-item--right">
                <div class="products_info">
                    <div class="products_name">Nike Dunk High Retro</div>
                ...
                <div class="mota">Sự rạng rỡ vẫn tồn tại trong Nike Dunk High Retro, phiên bản bóng rổ nguyên bản mang
